...
class ExemplePresentation(Slide):
    ...
    def construct(self):
        ...
        self.add(*self.theme.create_title_slide(title="Élasticité anisotrope\nen transformations finies"))
        self.wait()
        self.next_slide()
        
        # ===== SLIDE 2: PLAN =====
        self.clear()
        self.add(* self.theme.create_standard_slide(title_text="Plan"))
        ...
        self.clear()
        self.add(*self.theme.create_standard_slide(title_text="Hypothèses fondamentales"))
        ...
        self.clear()
        self.add(*self.theme.create_standard_slide(title_text="Comparaison des approches"))
        ...
        self.clear()
        self.add(*self.theme.create_standard_slide(title_text="Points importants"))
